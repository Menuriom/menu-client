...
<template>
    <div class="flex flex-col items-center gap-4 w-full pt-4">
        <div class="flex w-full mb-6" :style="`margin-top: -${options.imageMargin / 4}rem`">
            <Swiper
                :modules="[Pagination]"
                class="w-full"
        ...
        >
            ...
            <div
                id="price"
                class="sticky top-0 bottom-0 flex flex-wrap items-center justify-between gap-3 md:gap-4 pb-4 w-full rounded-b-md"
